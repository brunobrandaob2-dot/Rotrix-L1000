...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            rotrix::rotrix_ia_estado,
            rotrix::rotrix_ia_salvar,
            rotrix::rotrix_chave_salvar,
            rotrix::rotrix_chave_apagar,
            rotrix::rotrix_mascaras,
            rotrix::rotrix_fila,
            rotrix::rotrix_fila_salvar,
            rotrix::rotrix_fila_proximo,
            rotrix::rotrix_fila_escolher,
            ...
            rotrix::rotrix_correcao_listar,
            rotrix::rotrix_correcao_desfazer,
            rotrix::rotrix_versao_publicada,
            rotrix::rotrix_primeiros_passos,
            rotrix::rotrix_acao,
            rotrix::rotrix_colar,
            rotrix::rotrix_ia_texto,
    ...
    let mut app = builder
        ...
        .setup(move |app| {
            ...
            // Rotrix: sobe o Roteador de Laudos (pos-processamento local, porta 8123)
            {
                let h = app_handle.clone();
                std::thread::spawn(move || rotrix::iniciar(&h));
            }
